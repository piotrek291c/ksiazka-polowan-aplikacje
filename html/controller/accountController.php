...
class accountController extends baseController {
    ...
    public function register() {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $Numer_pozwolenia = trim($_POST['Numer_pozwolenia']);
            ...
            if (empty($Numer_pozwolenia)) {
                $error .= 'Uzupełnij pole numer pozwolenia  <br />';
            }
            if (empty($Data_urodzenia)) {
                $error .= 'Uzupełnij pole data urodzenia  <br />';
            }
            if (empty($email)) {
            ...
            if (empty($error)) {
                ...
                $user->setNumer_pozwolenia($Numer_pozwolenia);
                $user->setData_urodzenia($Data_urodzenia);
                $user->setEmail($email);
                $user->setLogin($login);
                $user->setHaslo($haslo);
                $user->setRole(array());
